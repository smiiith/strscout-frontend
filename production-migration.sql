...
ADD CONSTRAINT IF NOT EXISTS stripe_price_mappings_billing_type_check
CHECK (billing_type = ANY (ARRAY['subscription'::text, 'one_time'::text]));

ALTER TABLE public.stripe_price_mappings
ADD CONSTRAINT IF NOT EXISTS stripe_price_mappings_listing_count_check
CHECK (listing_count > 0);

ALTER TABLE public.stripe_price_mappings
ADD CONSTRAINT IF NOT EXISTS stripe_price_mappings_tier_check
CHECK (tier = ANY (ARRAY['starter'::text, 'growth'::text, 'pro'::text, 'portfolio'::text]));

ALTER TABLE public.profiles
ADD CONSTRAINT IF NOT EXISTS profiles_billing_type_check
CHECK (billing_type = ANY (ARRAY['subscription'::text, 'one_time'::text]));

ALTER TABLE public.profiles
ADD CONSTRAINT IF NOT EXISTS profiles_current_tier_check
...
ADD CONSTRAINT IF NOT EXISTS comps_comp_basis_id_fkey
FOREIGN KEY (comp_basis_id) REFERENCES public.comp_basis(id);

ALTER TABLE public.comps
ADD CONSTRAINT IF NOT EXISTS comps_profile_id_fkey
FOREIGN KEY (profile_id) REFERENCES public.profiles(id);

ALTER TABLE public.comps
ADD CONSTRAINT IF NOT EXISTS comps_scan_id_fkey
FOREIGN KEY (scan_id) REFERENCES public.comp_basis(scan_id);

ALTER TABLE public.comps_analysis
ADD CONSTRAINT IF NOT EXISTS comps_analysis_profile_id_fkey
FOREIGN KEY (profile_id) REFERENCES public.profiles(id);

ALTER TABLE public.comps_analysis
ADD CONSTRAINT IF NOT EXISTS comps_analysis_property_id_fkey
FOREIGN KEY (property_id) REFERENCES public.str_properties(id);

ALTER TABLE public.market_spy_runs
ADD CONSTRAINT IF NOT EXISTS market_spy_runs_profile_id_fkey
FOREIGN KEY (profile_id) REFERENCES public.profiles(id);

ALTER TABLE public.profiles
ADD CONSTRAINT IF NOT EXISTS profiles_plan_id_fkey
FOREIGN KEY (plan_id) REFERENCES public."plans"(id);

ALTER TABLE public.str_properties
ADD CONSTRAINT IF NOT EXISTS str_properties_comp_id_fkey
...
SET plan_id = '5cb61d3c-306e-4518-8ec1-fa59585ce27c'
