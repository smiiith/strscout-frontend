                ...
                <Card className="border-none">
                    <CardContent className="px-2 py-4 space-y-4">
                        ...
                        <p className="text-lg text-gray-800 max-w-3xl">
                            For many short-term rental hosts, knowing whether a listing truly stands out is a challenge.
                            Does your headline attract attention? Are your photos compelling? Are your amenities competitive?
