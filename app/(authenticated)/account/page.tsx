                  ...
                  {(profile.one_time_listings_balance || 0) > 0 ? (
                    <div className="space-y-3">
                      <div className="bg-blue-50 border border-blue-200 rounded p-3 space-y-2">
                        <div className="flex items-center justify-between text-sm">
                          ...
                          <span className="font-semibold">
                            {profile.one_time_listings_balance || 0} available
                          </span>
                        </div>
                        <p className="text-xs text-gray-600">
                          Never expires • Used first
                        </p>
                      </div>
                      ...
                      <div className="bg-green-50 border border-green-200 rounded p-3 space-y-2">
                        <div className="flex items-center justify-between text-sm">
                          ...
                          <span className="font-semibold">
                            {profile.subscription_quantity || 0}/month
                          </span>
                        </div>
                        <p className="text-xs text-gray-600">
                          Resets monthly • Used after prepaid
                        </p>
                      </div>
                      ...
                      <div className="pt-2 border-t">
                        <div className="flex items-center justify-between text-sm font-medium">
                          ...
                          <span>
                            {profile.market_spy_listings_limit || 0} reports
                          </span>
                        </div>
                    ...
                    <div>
                      <p className="text-sm mb-3">
                        {profile.subscription_quantity || 0} Market Spy reports
                        per month
                      </p>
                      <div className="flex items-center justify-between text-sm">
                        <span>
              ...
              <div className="space-y-4">
                <Message variant="info">
                  ...
                  <div className="flex items-center justify-between text-sm mb-4">
                    <span>
                      Reports: {profile.market_spy_listings_used || 0} /{" "}
                ...
                <div className="flex gap-3 pt-6 pb-8">
                  <Link href="/pricing">
                    <Button variant="outline">Buy More Reports</Button>
                  </Link>
