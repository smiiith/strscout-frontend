...
const PropertyCompsPage = () => {
        ...
        if (propertyRatings) {
          const categorized = {
            ...
            interiorDesign: {
              ...
              category:
                propertyRatings.ratings?.interior_design?.rating_category,
              feedback: {
                summary:
              ...
              suggestions:
                propertyRatings.ratings?.interior_design?.suggestions,
              displayOrder: 5,
            },
            feedback: {
  ...
  const BlurryCell = () => {
    return <TableCell className="blur-sm">sampledatasampledata</TableCell>;
  };
                ...
                <div className="flex flex-row mt-4 text-xl items-center">
                  <div className="">
                    <p className="font-bold text-3xl">
                      See What Top-Performing Listings Are Doing Differently.
                    </p>
