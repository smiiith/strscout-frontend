      ...
      <div className="container mx-auto px-0 grid grid-cols-12 gap-8">
        ...
        <div className="space-y-6 col-span-12 md:col-span-8 px-4 md:px-0 w-full pb-6 md:pb-0">
          <h1 className="text-6xl font-bold leading-tight">
            <div className="visible md:hidden text-5xl">You Need Clarity.</div>

            <div className="invisible h-0 md:visible md:h-auto">
              <ReactFitty>You Need Clarity.</ReactFitty>
            </div>
          ...
          <p className="text-xl text-gray-700 w-full">
            ...
            -- and what doesn't -- can feel like a guessing game.
          </p>

          <p className="text-xl text-gray-700">
            <span className="font-bold">STR Feedback Genius</span> takes the
            uncertainty out of the equation. We dive deep into your listing to
            provide analysis and actionable insights, ensuring you have the
            clarity you need to attract more guests and maximize your success.
          </p>
...
export default FeedbackGeniusHero;
