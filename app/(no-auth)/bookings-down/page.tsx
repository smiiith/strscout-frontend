...
export default function BookingsDownPage() {
  ...
  const structuredData = {
    ...
    "description": "Stop guessing why your Airbnb bookings are down. STR Market Spy reveals exactly how your competitors are performing and what they're doing differently to win more bookings.",
    ...
    <>
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="text-center space-y-6">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto">
              Stop guessing whether it's your pricing, visibility, or the market
              itself. <span className="font-semibold">STR Market Spy</span>{" "}
              reveals exactly how your competitors are performing — and what
              they're doing differently to win more bookings.
            </p>
      ...
      <Dialog open={videoOpen} onOpenChange={setVideoOpen}>
        <DialogContent className="w-[100vw] max-w-[100vw] left-0 right-0 translate-x-0 sm:max-w-3xl sm:left-[50%] sm:translate-x-[-50%] lg:max-w-4xl p-3 sm:p-6 gap-2 sm:gap-4 sm:rounded-lg rounded-none">
          <DialogHeader className="space-y-1">
            <DialogTitle className="text-base sm:text-lg pr-6">STR Market Spy Demo</DialogTitle>
        ...
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            <p className="text-lg text-muted-foreground text-center">
              ...
              could be costing you bookings. It's fast, free, and built to give
              hosts clarity before they make big changes.
            </p>
            ...
            <p className="text-sm text-muted-foreground text-center pt-4">
              Once you've seen how your own listing scores, you'll know whether
              the next step is optimizing — or analyzing the competition.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4 max-w-5xl">
          ...
          <div className="max-w-3xl mx-auto space-y-6">
            <p className="text-lg text-muted-foreground text-center">
              You'll finally see your real competition — not just who you think
              is competing with you — and understand exactly what separates you
              from the top performers.
            </p>

            <div className="flex justify-center">
              <Button size="lg" asChild>
                <Link href="/market-spy/analyze">Unlock My Market Report</Link>
              </Button>
            </div>
          </div>
        </div>
            ...
            <CardContent className="pt-6">
              <div className="text-center space-y-4">
                ...
                <p className="text-muted-foreground">
                  Just clear, actionable insight into your market — updated with
                  real data.
                </p>
              </div>
            </CardContent>
              ...
              <CardContent className="pt-6">
                <div className="space-y-4">
                  <p className="text-lg italic">
                    "STR Feedback Genius showed me what to fix in my photos. STR
                    Market Spy showed me who was beating me. Together, they gave
                    me the full picture."
                  </p>
