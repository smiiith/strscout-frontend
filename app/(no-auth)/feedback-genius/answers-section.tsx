      ...
      <div className="container mx-auto px-4 gap-8">
        <Card className="border-none bg-transparent">
          <CardContent className="px-2 py-4 space-y-4">
            ...
            <p className="!mt-0">
              Simply share your listing link, and we'll analyze it and provide a
              detailed report.
            </p>
            ...
            <p className="!mt-0">
              Most feedback reports are ready in minutes and are displayed here
              on the STR Feedback Genius site.
            </p>
            <p className="!mt-0">
              However, you don't need to wait as our feedback reports are also
              sent to your email free of charge.
            </p>
            ...
            <p className="!mt-0">
              Yes, it's really free. Seriously, no credit card, no BS, it's
              free. While we offer other paid services, this one is on us, no
              catch.
            </p>
